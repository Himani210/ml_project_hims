...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            numerical_faeture=["reading_score","writing_score"]
            ...
            preprocessor=ColumnTransformer(
                [
                    ("num_pipeline",num_pipeline,numerical_faeture),
    ...
    def initiatae_data_transformation(self,train_path,test_path):
        try:
            ...
            # target_feature_train_df=test_df.drop(columns=[target_column_name],axis=1)
